		...
		<>
			<section id="hobby" className={`${styles.maxWidth}`}>
				...
				<div className={`${styles.maxWidth} ${styles.flexBetween} flex-wrap items-stretch gap-4`}>
					...
					<CardHobby image={hobbyAtozMind} alt="ATOZ Mind" link="https://alamehan.github.io/alamehan-v1/mind-v2/" classCard="bg-pink-100" title="ATOZ Mind" description="A collection of mind maps on various topics. See the Big Picture!" />
