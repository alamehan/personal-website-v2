		...
		<>
			<section id="hobby" className={`${styles.maxWidth}`}>
				...
				<div className={`${styles.maxWidth} ${styles.flexBetween} flex-wrap items-stretch gap-4`}>
					...
					<CardHobby image={hobbyCheatSheet} alt="CheatSheet" link="https://alamehan.github.io/sheet/" classCard="bg-blue-100" title="CheatSheet" description="A ready-to-use reference, presented in a fun style with engaging illustrations." />
					<CardHobby image={hobbyNiceList} alt="NiceList" link="https://github.com/alamehan/nice-list" classCard="bg-violet-100" title="NiceList" description="A list of quality and useful websites and digital products in one place." />
					<CardHobby image={hobbyTheReaderrr} alt="The Readerrr" link="https://alamehan.github.io/epub/" classCard="bg-slate-100" title="The Readerrr" description="Curated for book lovers. Useful tools, book recommendations, and selected reading lists." />
					<CardHobby image={hobbyAtozMind} alt="ATOZ Mind" link="https://alamehan.github.io/mind-v2/" classCard="bg-pink-100" title="ATOZ Mind" description="A collection of mind maps on various topics. See the Big Picture!" />
					<CardHobby image={hobbyRightTr4ck} alt="Right Tr4ck" link="https://alamehan.github.io/road/" classCard="bg-orange-100" title="Right Tr4ck" description="A learning framework. Want to learn something new and don't know where to start?" />
					...
					{showMore && (
						<>
							<CardHobby image={hobbyDesignShowcase} alt="Design Showcase" link="https://alamehan.github.io/portfolios.html" classCard="bg-indigo-100" title="Design Showcase" description="Design exploration such as digital illustration, logo design, playing with color, etc." />
